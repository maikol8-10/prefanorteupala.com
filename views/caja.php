                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header with-border">
                                <h1 class="box-title" style="font-size: 22px; font-weight: bold">Flujo de caja
                            ...
                            <div class="panel-body" id="formularioregistro">
                                <form name="formulario" id="formulario" method="POST">
                                    ...
                                    <div class="form-group col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                        <label>Usuario(*):</label>
                                        <input type="hidden" name="idFlujo" id="idFlujo" hidden>
                                        <select id="idUsuario" name="idUsuario" class="form-control selectpicker"
                                    ...
                                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <label>Saldo:</label>
                                        <input type="number" class="form-control" name="saldo" id="saldo" min="1" max="999999" maxlength="50"
